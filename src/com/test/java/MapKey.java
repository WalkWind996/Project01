...
public class MapKey {
     ...
     * 16 格式化代码(reformat code) ctrl+shift+F
     17 提示当前方法参数类型(Parameter Info) ctrl+alt+/
     * 18 复制代码 ctrl + c
     * 19 撤销 ctrl + z
     20 反撤销 ctrl + y
     * 21 剪切 ctrl + x
     ...
     * 27 查看类的结构：类似于 eclipse 的 outline ctr+o
     28 重构：修改所有引用名为string的变量名与方法名(rename) alt+shift+r
     ...
     * 30 生成构造器/get/set/toString alt +shift + s
     ...
     35 生成 try-catch ,if-else等代码块(surround with) alt+shift+z
     ...
     * 37 查找/替换(当前) ctrl+f
     ...
     43 抽取代码块为方法(Extract Method) alt+shift+m
